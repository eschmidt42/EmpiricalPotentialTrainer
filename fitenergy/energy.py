...
from fitenergy.misc import translating_params, symmetrize_params, PairDistances, bond, bonded_group
from scipy.interpolate import interp1d

import itertools, copy, random
import numpy as np

def load_rhos(path): #TEMPORARY! borrowed from FitElectronDensity
...
class structure_template(translating_params):
    ...
    def get_stress_ase(self,delta=1e-3,eam=True):
        ...
        Ep1 = 0 #energy moving atom in + direction
        Em1 = 0 #energy moving atom in - direction
