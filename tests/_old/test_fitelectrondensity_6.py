...
pure Python without active self contribution compared with Fortran. Testing isotropic.
"""
...
class DensityRegressionFixture(unittest.TestCase):
    def setUp(self):
        ...
        self.load_path_bond_info = pre_path+"/unittest_files/test_density_withoutself.bonds"
