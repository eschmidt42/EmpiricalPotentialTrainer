...
pure Python without active self contribution. Testing anisotropic.
"""
...
class DensityRegressionFixture(unittest.TestCase):
    def setUp(self):
        ...
        # writing paths
        self.load_path_rhos = pre_path+"/unittest_files/test_density_withoutself_MEAM.rhos"
        #save_path_predicted = "./predicted_Ni3Al_ideal_dis.pred"
        self.load_path_Phi = pre_path+"/unittest_files/test_density_withoutself_MEAM.phi"
        self.load_path_bond_info = pre_path+"/unittest_files/test_density_withoutself_MEAM.bonds"
...
class Test_fitelectrondensity(DensityRegressionFixture):
    ...
    def test0_reproducing_obs(self):
